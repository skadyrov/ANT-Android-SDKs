...
public class Activity_MultiDeviceFilter extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mDeviceTypeListAdapter = new ArrayAdapter<String>(this,
				android.R.layout.simple_list_item_checked, getResources()
						.getStringArray(R.array.device_types));
			...
			public void onClick(View v) {
				...
				if (set.isEmpty()) {
					Toast.makeText(mContext,
							"Please select device type(s) to filter on.",
							Toast.LENGTH_SHORT).show();

				} else {
					Intent i = new Intent(mContext,
							Activity_MultiDeviceSearchSampler.class);
					Bundle args = new Bundle();
					args.putSerializable(
							Activity_MultiDeviceSearchSampler.FILTER_KEY, set);
					i.putExtra(Activity_MultiDeviceSearchSampler.BUNDLE_KEY,
							args);
					// Listen for search stopped results
					startActivityForResult(
							i,
							Activity_MultiDeviceSearchSampler.RESULT_SEARCH_STOPPED);
				}
			}
		});
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		if (resultCode == Activity_MultiDeviceSearchSampler.RESULT_SEARCH_STOPPED) {
			RequestAccessResult result = RequestAccessResult
					.getValueFromInt(data
							.getIntExtra(
			...
			case CHANNEL_NOT_AVAILABLE:
				Toast.makeText(this, "Channel Not Available",
						Toast.LENGTH_SHORT).show();
				break;
			...
			case BAD_PARAMS:
				...
				Toast.makeText(this, "Bad request parameters.",
						Toast.LENGTH_SHORT).show();
				break;
			case OTHER_FAILURE:
				Toast.makeText(this,
			...
			case UNRECOGNIZED:
				...
				break;
			default:
				Toast.makeText(this, "Unrecognized result: " + result,
						Toast.LENGTH_SHORT).show();
				break;
			}
		}
